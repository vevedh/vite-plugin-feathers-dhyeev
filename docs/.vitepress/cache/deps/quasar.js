...
var QSelect = createComponent({ name: "QSelect", inheritAttrs: false, props: { ...useVirtualScrollProps, ...useFormProps, ...useFieldProps, modelValue: { required: true }, multiple: Boolean, displayValue: [String, Number], displayValueHtml: Boolean, dropdownIcon: String, options: { type: Array, default: () => [] }, optionValue: [Function, String], optionLabel: [Function, String], optionDisable: [Function, String], hideSelected: Boolean, hideDropdownIcon: Boolean, fillInput: Boolean, maxValues: [Number, String], optionsDense: Boolean, optionsDark: { type: Boolean, default: null }, optionsSelectedClass: String, optionsHtml: Boolean, optionsCover: Boolean, menuShrink: Boolean, menuAnchor: String, menuSelf: String, menuOffset: Array, popupContentClass: String, popupContentStyle: [String, Array, Object], useInput: Boolean, useChips: Boolean, newValueMode: { type: String, validator: validateNewValueMode }, mapOptions: Boolean, emitValue: Boolean, inputDebounce: { type: [Number, String], default: 500 }, inputClass: [Array, String, Object], inputStyle: [Array, String, Object], tabindex: { type: [String, Number], default: 0 }, autocomplete: String, transitionShow: String, transitionHide: String, transitionDuration: [String, Number], behavior: { type: String, validator: (e) => ["default", "menu", "dialog"].includes(e), default: "default" }, virtualScrollItemSize: { type: [Number, String], default: void 0 }, onNewValue: Function, onFilter: Function }, emits: [...useFieldEmits, "add", "remove", "inputValue", "newValue", "keyup", "keypress", "keydown", "filterAbort"], setup(e, { slots: t, emit: o }) {
  ...
  function me(t2 = 1, o2) {
    if (true === l.value) {
      ...
      r.value !== n2 && (ve(n2), L(n2), true !== o2 && true === e.useInput && true === e.fillInput && $e(n2 >= 0 ? ae.value(e.options[n2]) : m));
    }
  }
  function fe(t2, o2) {
  ...
  function Se(t2) {
    ...
    if (void 0 === t2.keyCode)
      if (t2.target.value = "", null !== y && (clearTimeout(y), y = null), Ne(), "string" === typeof o2 && 0 !== o2.length) {
  ...
  function Ce(t2) {
    ...
    if (9 === t2.keyCode && false === a2)
      return void Ie();
    if (void 0 === t2.target || t2.target.id !== F.targetUid.value || true !== F.editable.value)
      return;
    ...
    if ((void 0 === g || b < Date.now()) && (g = ""), i2 > 0 && true !== e.useInput && void 0 !== t2.key && 1 === t2.key.length && false === t2.altKey && false === t2.ctrlKey && false === t2.metaKey && (32 !== t2.keyCode || 0 !== g.length)) {
      ...
      r.value !== s2 && nextTick(() => {
        ve(s2), L(s2), s2 >= 0 && true === e.useInput && true === e.fillInput && $e(ae.value(e.options[s2]));
      });
        ...
        if (true === n2) {
          const t3 = (t4, o2) => {
            if (o2) {
              ...
              o2 = e.newValueMode;
            if (Me("", true !== e.multiple, true), void 0 === t4 || null === t4)
              return;
  ...
  function Be(t2, a2, i2) {
    if (void 0 === e.onFilter || true !== a2 && true !== F.focused.value)
      return;
    true === F.innerLoading.value ? o("filterAbort") : (F.innerLoading.value = true, c.value = true), "" !== t2 && true !== e.multiple && 0 !== R.value.length && true !== v && t2 === ae.value(R.value[0]) && (t2 = "");
    const r2 = setTimeout(() => {
  ...
  function Fe() {
    const o2 = [h(QField, { class: `col-auto ${F.fieldClass.value}`, ...D.value, for: F.targetUid.value, dark: z.value, square: true, loading: c.value, itemAligned: false, filled: true, stackLabel: 0 !== s.value.length, ...F.splitAttrs.listeners.value, onFocus: Le, onBlur: Oe }, { ...t, rawControl: () => F.getControl(true), before: void 0, after: void 0 })];
  ...
  function ze() {
    const e2 = document.activeElement;
    null !== e2 && e2.id === F.targetUid.value || null === C.value || C.value === e2 || C.value.focus(), O();
  }
  function Ie() {
  ...
  function Ne() {
    true === e.useInput && Me(true !== e.multiple && true === e.fillInput && 0 !== R.value.length && ae.value(R.value[0]) || "", true, true);
  }
  function je(t2) {
    let o2 = -1;
    if (true === t2) {
  ...
  return watch(R, (t2) => {
    ...
    if (true === e.useInput)
      ...
      o2.push(h("input", { ref: true === n2 ? C : void 0, key: "d_t", class: "q-select__focus-target", id: true === n2 ? F.targetUid.value : void 0, value: U.value, readonly: true, "data-autofocus": true === t2 || true === e.autofocus || void 0, ...a3, onKeydown: Ce, onKeyup: ye, onKeypress: we })), true === n2 && "string" === typeof e.autocomplete && 0 !== e.autocomplete.length && o2.push(h("input", { class: "q-select__autocomplete-input", autocomplete: e.autocomplete, tabindex: -1, onKeyup: Se }));
    }
    if (void 0 !== q.value && true !== e.disable && 0 !== ie.value.length) {
...
var Quasar = { version: "2.12.6", install(e, t, o) {
